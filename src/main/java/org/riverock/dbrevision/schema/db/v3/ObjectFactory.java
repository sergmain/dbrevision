 ...
 * generated in the org.riverock.dbrevision.schema.db.v3 package. 
...
public class ObjectFactory {
    ...
    private final static QName _Schema_QNAME = new QName("http://dbrevision.sourceforge.net/xsd/dbrevision-structure-3.0.xsd", "Schema");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: org.riverock.dbrevision.schema.db.v3
     * 
     */
    ...
    /**
     * Create an instance of {@link DbViewReplacement }
     * 
     */
    public DbViewReplacement createDbViewReplacement() {
        return new DbViewReplacement();
    }
    ...
    /**
     * Create an instance of {@link DbSequenceReplacement }
     * 
     */
    public DbSequenceReplacement createDbSequenceReplacement() {
        return new DbSequenceReplacement();
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://dbrevision.sourceforge.net/xsd/dbrevision-structure-3.0.xsd", name = "Schema")
    public JAXBElement<DbSchema> createSchema(DbSchema value) {
        return new JAXBElement<DbSchema>(_Schema_QNAME, DbSchema.class, null, value);
    }
