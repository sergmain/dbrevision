 ...
 *           &lt;element name="Table" type="{http://dbrevision.sourceforge.net/xsd/dbrevision-structure-3.0.xsd}DbTable"/>
 *           &lt;element name="Sequence" type="{http://dbrevision.sourceforge.net/xsd/dbrevision-structure-3.0.xsd}DbSequence"/>
 *           &lt;element name="ForeignKey" type="{http://dbrevision.sourceforge.net/xsd/dbrevision-structure-3.0.xsd}DbForeignKey"/>
 *           &lt;element name="Index" type="{http://dbrevision.sourceforge.net/xsd/dbrevision-structure-3.0.xsd}DbIndex"/>
 *           &lt;element name="PrimaryKey" type="{http://dbrevision.sourceforge.net/xsd/dbrevision-structure-3.0.xsd}DbPrimaryKey"/>
